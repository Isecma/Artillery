...
public class SeguirCamara : MonoBehaviour
{
    ...
    private void FixedUpdate()
    {
        ...
        destino.x = Mathf.Max(limiteXY.x, destino.x); //Toma el más grande de ambos números, en caso de que destino.x sea negativo, limiteXY.x es igual a 0
        destino.y = Mathf.Max(limiteXY.y, destino.y);
        destino = Vector3.Lerp(transform.position, destino, suavizado); //Interpolación
        destino.z = camZ;
